...
################################################################################
## Form generated from reading UI file 'mainwindowACDoyA.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy1.setHeightForWidth(self.AnnotationBox.sizePolicy().hasHeightForWidth())
        self.AnnotationBox.setSizePolicy(sizePolicy1)
